    ...
    return (
        <section className="lockersPage-container">
            ...
            <main className="lockers-main-content">
                <img src="https://lipsum.app/1920x1080" alt="Lockers building" className="imagePlaceholder"/>
