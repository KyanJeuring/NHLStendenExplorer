...
('Study Landscape Logistics & International Business', 'Time to study!', ARRAY['STUDY_AREAS']::category_enum[], './photos/logistics-study-landscape.jpeg', '/studylandscapelogistics'),
...
('Study Abroad', 'Looking to study abroad? The sky is the limit!', ARRAY['SERVICES']::category_enum[], './photos/study-abroad.jpeg', '/studyabroad'),
